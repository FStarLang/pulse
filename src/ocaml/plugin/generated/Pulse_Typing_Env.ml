      ...
      (FStar_Sealed.seal
         (Obj.magic
            (FStar_Range.mk_range "Pulse.Typing.Env.fst" (Prims.of_int (381))
               (Prims.of_int (4)) (Prims.of_int (390)) (Prims.of_int (74)))))
      (FStar_Tactics_Effect.lift_div_tac
         (fun uu___ ->
            fun uu___1 ->
              match uu___1 with
                 ...
                 (FStar_Sealed.seal
                    (Obj.magic
                       (FStar_Range.mk_range "Pulse.Typing.Env.fst"
                          ...
                          (Prims.of_int (390)) (Prims.of_int (74)))))
                 (FStar_Tactics_Effect.lift_div_tac
                    (fun uu___ ->
                       fun vtns ->
                           ...
                           (fun uu___1 ->
                              ...
                              | ((n, t), x) ->
                                  FStar_Tactics_Effect.tac_bind
                                    ...
                                    (FStar_Tactics_Effect.lift_div_tac
                                       (fun uu___2 ->
                                          FStar_Reflection_TermEq.term_eq t
                    ...
                    (fun maybe_filter ->
                       Obj.magic
                         (FStar_Tactics_Effect.tac_bind
                                        ...
                                        (FStar_Sealed.seal
                                           (Obj.magic
                                              (FStar_Range.mk_range
                                                 ...
                                                 (Prims.of_int (36)))))
                                        (Obj.magic
                                           (FStar_Tactics_Util.zip e.bs
                                              e.names))
                                        (fun uu___ ->
                                           (fun uu___ ->
                                              Obj.magic (maybe_filter uu___))
                                             uu___)))
                                  (fun uu___ ->
                                     (fun uu___ ->
                                        Obj.magic
                            ...
                            (fun uu___ ->
                               FStar_Tactics_Effect.lift_div_tac
                                 (fun uu___1 -> FStar_Pprint.brackets uu___))))
                      uu___))) uu___)
let (get_range :
  env ->
            ...
            (FStar_Sealed.seal
               (Obj.magic
                  (FStar_Range.mk_range "Pulse.Typing.Env.fst"
                     ...
                     (Prims.of_int (396)) (Prims.of_int (27)))))
            (FStar_Sealed.seal
               (Obj.magic
                  (FStar_Range.mk_range "Pulse.Typing.Env.fst"
            ...
            (FStar_Sealed.seal
               (Obj.magic
                  (FStar_Range.mk_range "Pulse.Typing.Env.fst"
                     ...
                     (Prims.of_int (401)) (Prims.of_int (23)))))
            (FStar_Sealed.seal
               (Obj.magic
                  (FStar_Range.mk_range "Pulse.Typing.Env.fst"
                     (Prims.of_int (401)) (Prims.of_int (26))
                     (Prims.of_int (414)) (Prims.of_int (43)))))
                  ...
                  Obj.magic
                    (FStar_Tactics_Effect.tac_bind
                       (FStar_Sealed.seal
                          (Obj.magic
                             (FStar_Range.mk_range "Pulse.Typing.Env.fst"
                                (Prims.of_int (402)) (Prims.of_int (11))
                                (Prims.of_int (410)) (Prims.of_int (12)))))
                       (FStar_Sealed.seal
                          (Obj.magic
                             (FStar_Range.mk_range "Pulse.Typing.Env.fst"
                                (Prims.of_int (411)) (Prims.of_int (4))
                                (Prims.of_int (414)) (Prims.of_int (43)))))
                       (Obj.magic
                          (FStar_Tactics_Effect.tac_bind
                             (FStar_Sealed.seal
                     ...
                     (FStar_Sealed.seal
                        (Obj.magic
                           (FStar_Range.mk_range "Pulse.Typing.Env.fst"
                              ...
                              (Prims.of_int (418)) (Prims.of_int (83)))))
                     (FStar_Sealed.seal
                        (Obj.magic
                           (FStar_Range.mk_range "Pulse.Typing.Env.fst"
                     ...
                     (Obj.magic
                        (FStar_Tactics_Effect.tac_bind
                           (FStar_Sealed.seal
                              (Obj.magic
                                 (FStar_Range.mk_range "Pulse.Typing.Env.fst"
                                    (Prims.of_int (418)) (Prims.of_int (67))
                                    (Prims.of_int (418)) (Prims.of_int (83)))))
                           (FStar_Sealed.seal
                              (Obj.magic
                                 (FStar_Range.mk_range "Pulse.Typing.Env.fst"
                     ...
                     (FStar_Sealed.seal
                        (Obj.magic
                           (FStar_Range.mk_range "Pulse.Typing.Env.fst"
                              ...
                              (Prims.of_int (423)) (Prims.of_int (80)))))
                     (FStar_Sealed.seal
                        (Obj.magic
                           (FStar_Range.mk_range "Pulse.Typing.Env.fst"
                     ...
                     (Obj.magic
                        (FStar_Tactics_Effect.tac_bind
                           (FStar_Sealed.seal
                              (Obj.magic
                                 (FStar_Range.mk_range "Pulse.Typing.Env.fst"
                                    (Prims.of_int (423)) (Prims.of_int (64))
                                    (Prims.of_int (423)) (Prims.of_int (80)))))
                           (FStar_Sealed.seal
                              (Obj.magic
                                 (FStar_Range.mk_range "Pulse.Typing.Env.fst"
      ...
      fun msg ->
        FStar_Tactics_Effect.tac_bind
          (FStar_Sealed.seal
             (Obj.magic
                (FStar_Range.mk_range "Pulse.Typing.Env.fst"
                   (Prims.of_int (427)) (Prims.of_int (17))
                   (Prims.of_int (427)) (Prims.of_int (45)))))
          (FStar_Sealed.seal
             (Obj.magic
                (FStar_Range.mk_range "Pulse.Typing.Env.fst"
                   (Prims.of_int (428)) (Prims.of_int (2))
                   (Prims.of_int (430)) (Prims.of_int (3)))))
          (FStar_Tactics_Effect.lift_div_tac
             (fun uu___ ->
                fun d ->
                  FStar_Pprint.nest (Prims.of_int (2))
                ...
                Obj.magic
                  (FStar_Tactics_Effect.tac_bind
                     (FStar_Sealed.seal
                        (Obj.magic
                           (FStar_Range.mk_range "Pulse.Typing.Env.fst"
                              (Prims.of_int (428)) (Prims.of_int (15))
                              (Prims.of_int (430)) (Prims.of_int (3)))))
                     (FStar_Sealed.seal
                        (Obj.magic
                           (FStar_Range.mk_range "Pulse.Typing.Env.fst"
                     ...
                     (Obj.magic
                        (FStar_Tactics_Effect.tac_bind
                           (FStar_Sealed.seal
                              (Obj.magic
                                 (FStar_Range.mk_range "Pulse.Typing.Env.fst"
                                    (Prims.of_int (429)) (Prims.of_int (4))
                                    (Prims.of_int (429)) (Prims.of_int (69)))))
                           (FStar_Sealed.seal
                              (Obj.magic
                                 (FStar_Range.mk_range "Pulse.Typing.Env.fst"
                                    (Prims.of_int (428)) (Prims.of_int (15))
