...
let (vprop_to_ast_term :
  ...
  fun v ->
    ...
    | PulseSyntaxExtension_Sugar.VPropTerm t ->
    ...
    (fun c ->
       ...
       let head =
         ...
         | PulseSyntaxExtension_Sugar.STGhost ->
             ...
             h1 in
       let uu___ =
         vprop_to_ast_term c.PulseSyntaxExtension_Sugar.precondition in
       Obj.magic
           ...
           | () ->
               let uu___1 =
                 FStar_ToSyntax_ToSyntax.desugar_term
                   (env.PulseSyntaxExtension_Env.tcenv).FStar_TypeChecker_Env.dsenv
                   t in
                          ...
                          FStar_Class_Monad.op_let_Bang
                            ...
                            (fun uu___4 ->
                               (fun l1 ->
                                  ...
                                  let uu___4 =
                                    interpret_vprop_constructors env r in
                                  Obj.magic
                                    (FStar_Class_Monad.op_let_Bang
                                       PulseSyntaxExtension_Err.err_monad ()
                                       () (Obj.magic uu___4)
...
let (desugar_vprop :
  PulseSyntaxExtension_Env.env_t ->
    PulseSyntaxExtension_Sugar.vprop ->
      PulseSyntaxExtension_SyntaxWrapper.vprop PulseSyntaxExtension_Err.err)
  =
  fun uu___1 ->
    fun uu___ ->
      (fun env ->
                 ...
                 (FStar_Class_Monad.op_let_Bang
                    ...
                    (fun uu___1 ->
                       (fun t1 ->
                          ...
                          Obj.magic (interpret_vprop_constructors env t1))
                         uu___1))) uu___1 uu___
  ...
  fun uu___1 ->
    fun uu___ ->
      (fun env ->
         fun c ->
           let uu___ =
             desugar_vprop env c.PulseSyntaxExtension_Sugar.precondition in
           Obj.magic
             (FStar_Class_Monad.op_let_Bang
                PulseSyntaxExtension_Err.err_monad () () (Obj.magic uu___)
                (fun uu___1 ->
                          ...
                          | (env1, bs, bvs) ->
                              let uu___2 =
                                ...
                                | FStar_Pervasives_Native.Some t ->
                                    Obj.magic
                                      (Obj.repr
                                         (let uu___3 = desugar_term env1 t in
                                          FStar_Class_Monad.op_let_Bang
                                            PulseSyntaxExtension_Err.err_monad
                                            () () (Obj.magic uu___3)
                                            (fun uu___4 ->
            ...
            (fun env1 ->
               fun uu___ ->
                 ...
                 | (m, n) ->
                     ...
                     let uu___2 =
                       FStar_Ident.lid_of_path n PulseSyntaxExtension_Env.r_ in
