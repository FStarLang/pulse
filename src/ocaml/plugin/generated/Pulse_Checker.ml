              ...
              (FStar_Sealed.seal
                 (Obj.magic
                    (FStar_Range.mk_range "Pulse.Checker.fst"
                       ...
                       (Prims.of_int (174)) (Prims.of_int (31)))))
              (FStar_Sealed.seal
                 (Obj.magic
                    (FStar_Range.mk_range "Pulse.Checker.fst"
                       (Prims.of_int (174)) (Prims.of_int (5))
                            ...
                            let uu___3 =
                              let uu___4 =
                                Obj.magic
                                  (FStar_Tactics_Effect.lift_div_tac
                                     (fun uu___5 ->
                                        Pulse_Syntax_Pure.slprop_as_list pre)) in
                              FStar_Tactics_Effect.tac_bind
                                (FStar_Sealed.seal
                                   (Obj.magic
                                      (FStar_Range.mk_range
                                      ...
                                      let uu___5 =
                                        ...
                                        FStar_Tactics_Effect.tac_bind
                                          ...
                                          (fun uu___7 ->
                                             FStar_Tactics_Effect.lift_div_tac
                                               (fun uu___8 ->
                                                  Pulse_Json.JsonAssoc uu___7)) in
                                      Obj.magic
                                        (FStar_Tactics_Effect.tac_bind
                                           (FStar_Sealed.seal
                                              (Obj.magic
                        ...
                        (FStar_Sealed.seal
                           (Obj.magic
                              (FStar_Range.mk_range "Pulse.Checker.fst"
                                 ...
                                 (Prims.of_int (197)) (Prims.of_int (59)))))
                        (FStar_Sealed.seal
                           (Obj.magic
                              (FStar_Range.mk_range "Pulse.Checker.fst"
                                 (Prims.of_int (195)) (Prims.of_int (7))
                                 (Prims.of_int (338)) (Prims.of_int (3)))))
                        (Obj.magic uu___2)
                        (fun uu___3 ->
                           (fun uu___3 ->
                              match uu___3 with
