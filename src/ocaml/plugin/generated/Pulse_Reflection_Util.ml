...
let (u_three : FStar_Reflection_Types.universe) =
  FStar_Reflection_Typing.u_succ
    (FStar_Reflection_Typing.u_succ
       (FStar_Reflection_Typing.u_succ FStar_Reflection_Typing.u_zero))
let (u_four : FStar_Reflection_Types.universe) =
  FStar_Reflection_Typing.u_succ
    (FStar_Reflection_Typing.u_succ
       (FStar_Reflection_Typing.u_succ
          (FStar_Reflection_Typing.u_succ FStar_Reflection_Typing.u_zero)))
...
let (slprop_fv : FStar_Reflection_Types.fv) =
  FStar_Reflection_V2_Builtins.pack_fv slprop_lid
let (slprop_tm : FStar_Reflection_Types.term) =
  FStar_Reflection_V2_Builtins.pack_ln
    (FStar_Reflection_V2_Data.Tv_FVar slprop_fv)
...
let (slprop_equiv_norm_tm : FStar_Reflection_Types.term) =
  FStar_Reflection_V2_Builtins.pack_ln
  ...
  fun u ->
    fun a ->
      let t =
        FStar_Reflection_V2_Builtins.pack_ln
          (FStar_Reflection_V2_Data.Tv_UInst
             ((FStar_Reflection_V2_Builtins.pack_fv non_informative_lid),
               [u])) in
      let t1 =
        FStar_Reflection_V2_Builtins.pack_ln
          (FStar_Reflection_V2_Data.Tv_App
             (t, (a, FStar_Reflection_V2_Data.Q_Explicit))) in
      t1
let (stt_slprop_equiv_fv : FStar_Reflection_Types.fv) =
  FStar_Reflection_V2_Builtins.pack_fv (mk_pulse_lib_core_lid "slprop_equiv")
let (stt_slprop_equiv_tm : FStar_Reflection_Types.term) =
  FStar_Reflection_V2_Builtins.pack_ln
    (FStar_Reflection_V2_Data.Tv_FVar stt_slprop_equiv_fv)
  ...
  fun t1 ->
    fun t2 ->
      let t =
        FStar_Reflection_V2_Builtins.pack_ln
          (FStar_Reflection_V2_Data.Tv_App
             (stt_slprop_equiv_tm, (t1, FStar_Reflection_V2_Data.Q_Explicit))) in
      FStar_Reflection_V2_Builtins.pack_ln
        (FStar_Reflection_V2_Data.Tv_App
                    ...
                    fun e2 ->
                      ...
                      let t3 =
                        FStar_Reflection_V2_Builtins.pack_ln
                          (FStar_Reflection_V2_Data.Tv_App
                             (t2,
                               (opens, FStar_Reflection_V2_Data.Q_Implicit))) in
                      let t4 =
                        FStar_Reflection_V2_Builtins.pack_ln
                          (FStar_Reflection_V2_Data.Tv_App
                             (t3,
...
let (mk_array : FStar_Reflection_Types.term -> FStar_Reflection_Types.term) =
  fun a ->
    let t =
      FStar_Reflection_V2_Builtins.pack_ln
        (FStar_Reflection_V2_Data.Tv_FVar
           (FStar_Reflection_V2_Builtins.pack_fv array_lid)) in
    FStar_Reflection_V2_Builtins.pack_ln
      (FStar_Reflection_V2_Data.Tv_App
         (t, (a, FStar_Reflection_V2_Data.Q_Explicit)))
let (mk_array_length :
  ...
  fun a ->
    fun arr ->
      let t =
        FStar_Reflection_V2_Builtins.pack_ln
          (FStar_Reflection_V2_Data.Tv_FVar
             (FStar_Reflection_V2_Builtins.pack_fv array_length_lid)) in
      let t1 =
        FStar_Reflection_V2_Builtins.pack_ln
          (FStar_Reflection_V2_Data.Tv_App
             (t, (a, FStar_Reflection_V2_Data.Q_Implicit))) in
      ...
      fun perm ->
        fun v ->
          let t =
            FStar_Reflection_V2_Builtins.pack_ln
              (FStar_Reflection_V2_Data.Tv_FVar
                 (FStar_Reflection_V2_Builtins.pack_fv array_pts_to_lid)) in
          let t1 =
            FStar_Reflection_V2_Builtins.pack_ln
              (FStar_Reflection_V2_Data.Tv_App
                 (t, (a, FStar_Reflection_V2_Data.Q_Implicit))) in
          let t2 =
            FStar_Reflection_V2_Builtins.pack_ln
              (FStar_Reflection_V2_Data.Tv_App
                 (t1, (arr, FStar_Reflection_V2_Data.Q_Explicit))) in
          let t3 =
            FStar_Reflection_V2_Builtins.pack_ln
              (FStar_Reflection_V2_Data.Tv_App
                 (t2, (perm, FStar_Reflection_V2_Data.Q_Implicit))) in
              ...
              fun post ->
                fun body ->
                  ...
                  let t =
                    FStar_Reflection_V2_Builtins.pack_ln
                      (FStar_Reflection_V2_Data.Tv_UInst
                         ((FStar_Reflection_V2_Builtins.pack_fv lid),
                           [ret_u])) in
                  let t1 =
                    FStar_Reflection_V2_Builtins.pack_ln
                      (FStar_Reflection_V2_Data.Tv_App
                  ...
                  let t3 =
                    FStar_Reflection_V2_Builtins.pack_ln
                      (FStar_Reflection_V2_Data.Tv_App
                         (t2, (len, FStar_Reflection_V2_Data.Q_Explicit))) in
                  let t4 =
                    FStar_Reflection_V2_Builtins.pack_ln
                      (FStar_Reflection_V2_Data.Tv_App
                         (t3, (pre, FStar_Reflection_V2_Data.Q_Implicit))) in
                  let t5 =
                    FStar_Reflection_V2_Builtins.pack_ln
                      (FStar_Reflection_V2_Data.Tv_App
                         (t4, (ret_t, FStar_Reflection_V2_Data.Q_Implicit))) in
                  let t6 =
                    FStar_Reflection_V2_Builtins.pack_ln
                      (FStar_Reflection_V2_Data.Tv_App
                         (t5, (post, FStar_Reflection_V2_Data.Q_Implicit))) in
