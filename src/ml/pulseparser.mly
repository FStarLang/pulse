...
%token PRESERVES
%token GOTO LABEL BREAK CONTINUE RETURN CLEANUP
...
pulseStmtNoSeq:
  ...
  | CLEANUP pre=appTermNoRecordExp LBRACE handler=pulseStmt RBRACE
    { PulseSyntaxExtension_Sugar.mk_cleanup pre handler }
