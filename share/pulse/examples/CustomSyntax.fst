...
#push-options "--ide_id_info_off --print_full_names --ugly"

assume val p (x:int) : vprop
assume val q (x:int) : vprop

assume val f (x:int) : stt int emp (fun r -> p r)
assume val g () : stt int (exists* r. p r) (fun s -> q s)
