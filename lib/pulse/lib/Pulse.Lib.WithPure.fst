...
let placeless_with_pure p v #_ = Tactics.Typeclasses.solve
let is_send_with_pure p v #_ = Tactics.Typeclasses.solve
let is_sync_with_pure p v #_ = Tactics.Typeclasses.solve
