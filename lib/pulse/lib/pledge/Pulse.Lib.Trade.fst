...
ghost
fn placeless_trade #is
  (p1 p2: slprop) {| i1: placeless p1, i2: placeless p2 |}
  : placeless (trade #is p1 p2) = l1 l2 {
...
ghost
fn is_sync_trade #is
  (p1 p2: slprop) {| i1: is_sync p1, i2: is_sync p2 |}
  : is_sync (trade #is p1 p2) = l1 l2 {
  ghost_impersonate l2 (on l1 (trade #is p1 p2)) (on l2 (trade #is p1 p2)) fn _ {
    loc_dup l2;
    intro (trade #is p1 p2) #(on l1 (trade #is p1 p2) ** loc l2) fn _ {
      on_intro p1;
