...
fn new_lock (v:storable)
requires v
returns l:lock
ensures lock_alive l v

fn acquire (#v:slprop) (#p:perm) (l:lock)
...
ghost
fn share2 (#v:slprop) (l:lock)
requires lock_alive l v
ensures lock_alive l #0.5R v ** lock_alive l #0.5R v
...
[@@allow_ambiguous]
ghost
fn gather2 (#v:slprop) (l:lock)
requires lock_alive l #0.5R v ** lock_alive l #0.5R v
ensures lock_alive l v
...
ghost
fn lock_alive_inj (l:lock) (#p1 #p2 : perm) (#v1 #v2 : slprop)
...
val lock_active (#[T.exact (`1.0R)] p:perm) (l:lock) : slprop2
